...
console.log(getStringFromTemplate('Kokosh', "Vlad"))
...
console.log(extractNameFromTemplate('Hello, Kokosh Vlad!'))
...
console.log(getFirstChar('Kokosh Vlad'))
...
console.log(convertToUpperCase('Asdasdasda'))
...
function encodeToRot13(str) {
    ...
    const arrCharCode = arrStr.map(symbol => symbol.charCodeAt(0))
    return arrCharCode.map(symbol => String.fromCharCode(symbol+13))
}

console.log(encodeToRot13('ABC'))
